...
APPROVAL_CHOICES = (('1', '待审核'), ('2', '已发布'), ('3', '已驳回'))
OPERATION_CHOICES = (('1', '全部操作系统类型'), ('2', 'IOS系统'), ('3', 'Android系统'))
GENDER_CHOICES = (('1', '全部性别'), ('2', '男性用户'), ('3', '女性用户'))
AGE_CHOICES = (('1', '全部年龄层'), ('2', '20~40岁用户'), ('3', '40~60岁用户'), ('4', '60岁以上用户'))
AUTHENTICATION_CHOICES = (('1', '全部认证方式'), ('2', 'A 类认证'), ('3', 'B 类认证'), ('4', 'C 类认证'),
                          ('5', 'D 类认证'))
CERTIFICATES_CHOICES = (('1', '全部认证类型'), ('2', '身份证'), ('3', '护照'), ('4', '军官证'),
                        ('5', '台胞证'))
